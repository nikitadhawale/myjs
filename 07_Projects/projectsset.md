...
form.addEventListener('submit', function (e) {
  ...
  if (height === '' || height < 0 || isNaN(height)) {
    ...
    if (bmi < 18.9) {
      results.innerHTML += `<br>Your weight is underweight`;
    } else if (bmi >= 18.9 && bmi <= 24.9) {
      results.innerHTML += `<br>Your weight is normal`;
    } else if (bmi > 24.9) {
      results.innerHTML += `<br>Your weight is overweight`;
    }
  }
});
...
//check whether the value is correct guess msg
